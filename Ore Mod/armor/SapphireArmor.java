...
public class SapphireArmor extends ItemArmor {
	...
	public void registerIcons(IconRegister reg) {
		if (itemID == Ores.sapHelmet.itemID) {
			this.itemIcon = reg.registerIcon("oremod:sap_helmet");
		} else if (itemID == Ores.sapChest.itemID){
			this.itemIcon = reg.registerIcon("oremod:sap_chestplate");
		} else if (itemID == Ores.sapLeggings.itemID) {
			this.itemIcon = reg.registerIcon("oremod:sap_leggings");
		} else if (itemID == Ores.sapBoots.itemID) {
			this.itemIcon = reg.registerIcon("oremod:sap_boots");
		}
	}
	...
	public String getArmorTexture(ItemStack stack, Entity entity, int slot, int layer) {
		if (slot == 2) {
			return "oremod:textures/armor/sapphirearmor_2.png";
		} else {
			return "oremod:textures/armor/sapphirearmor_1.png";
		}
	}
}
